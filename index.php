...
<body id="top">
  ...
  <main>
    <article>
      ...
      <!--SERVICE-->
<section class="section service" id="pp" aria-label="service">
  <div class="container">
    ...
    <form class="donor-form" action="donarinfo.php" method="POST">
      ...
      <button type="submit" class="btn" name="fndnr" >Find Donor</button>
    </form>
  </div>
</section>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["email_address"]) && filter_var($_POST["email_address"], FILTER_VALIDATE_EMAIL)) {
        ...
        $qy = "INSERT INTO response_back VALUES ('$email')";
