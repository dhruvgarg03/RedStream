...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   // $donations = isset($_POST["donations"]) ? htmlspecialchars($_POST["donations"]) : "";
  $donations='NULL';
    ...
    //$stmt = $conn->prepare("INSERT INTO registered_users  VALUES ($name,$email,$phone,$password,$bloodgroup,$gender,$birthdate,$weight,$state,$zipcode,$district,$area,$landmarks)");
    $qy = "INSERT INTO registered_users VALUES ('$name','$email','$phone','$password','$bloodgroup','$gender','$birthdate','$weight','$state','$zipcode','$district','$area','$landmarks')";
